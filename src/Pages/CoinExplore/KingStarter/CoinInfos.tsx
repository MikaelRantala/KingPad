  ...
  return (
    <CoinInfosContainer>
      <CoinInfosBox>
        ...
        <CoinInfo name="Liquidity Lockup Time" value={`${data?.liquidity_lock_days ?? 0} days`} />
      </CoinInfosBox>
      <ContributionBox>
        <VestingCard>
          <CardLabel>Contribution Vesting</CardLabel>
          <VestingDetails>
            <VestingDetail value={data?.vesting_first_release_amount ?? 0} unit="%" content="First release Amount" />
            <VestingDetail
              value={data?.vesting_period_each_cycle_days ?? 0}
              unit="DAYS"
              content="Vesting period each cycle"
            />
            <VestingDetail
              value={data?.vesting_release_each_cycle_percentage ?? 0}
              unit="%"
